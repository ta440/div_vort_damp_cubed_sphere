...
def plot_cubed_sphere_panels(ax, units='deg', color='black', shift_fact=None, linewidth=None,
                             projection=None):
    """
    ...
    Args:
        ...
        shift_fact: Defines a shift in the cubed-sphere. FV3 shifts the grid
        westwards by 10 deg, which is shift_fact = -10.
    ...
    for edge in edges_lonlat:
        ...
        ax.plot(x_coords*unit_factor + shift_fact, y_coords*unit_factor, color=color,
